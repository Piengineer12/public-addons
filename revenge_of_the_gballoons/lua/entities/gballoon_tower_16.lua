...
ENT.UpgradeReference = {
	...
	},
	{
		...
		Descs = {
			...
			"For each player, this tower generates additional cash equal to 0.5% of their current cash per second, up to $100 per second. Only works while gBalloons are present.",
			"This tower now generates 1% interest, up to $500 per second.",
			"This tower now generates interest from current cash AND placed towers, up to $2,500 per second.",
			"This tower now generates interest up to $25,000 per second!",
