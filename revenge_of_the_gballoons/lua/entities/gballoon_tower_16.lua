...
ENT.UpgradeReference = {
	...
	{
		Names = {"Long Lasting Hoverballs", "Auto-Sell", "Compound Interest", "Garry's Bank", "Big City", "Grand Metropolis", "Almost There", "INFINITE GROWTH!"},
		Descs = {
			"Hoverballs last for 200% longer.",
			"Hoverballs are now automatically removed. All health generated by this tower is doubled.",
			"For each player, this tower generates additional cash equal to 0.2% of their current cash per second, up to $100 per second. Only works while gBalloons are present.",
			"This tower now generates 0.5% interest, up to $500 per second.",
			"This tower generates 1% interest from current cash AND placed towers, up to $2,000 per second.",
			"This tower generates 2% interest, up to $10,000 per second!",
			"This tower generates 1% interest again, but up to $100,000 per second!",
		...
		Prices = {450,1300,4000,20000,100000,500000,2500000,100000000},
		Funcs = {
			function(self)
			...
			function(self)
				...
				self.rotgb_BankMax = 2000
				self.rotgb_BankBonus = true
			end,
			function(self)
				self.rotgb_BankFactor = 0.02
				self.rotgb_BankMax = 10000
			end,
			function(self)
				self.rotgb_BankFactor = 0.01
				self.rotgb_BankMax = 100000
			end,
			function(self)
	...
	},
	{
		...
		Descs = {
			...
			"This tower no longer generates hoverballs. Instead, at the start of each round, gain 40 seconds worth of hoverball cash that would have been generated.",
		...
		Funcs = {
			...
			function(self)
				...
				self.rotgb_HoverballPostCash = self.rotgb_HoverballPostCash * 4
			end,
			function(self)
