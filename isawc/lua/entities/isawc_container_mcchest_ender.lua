...
ENT.ContainerModel = Model("models/mcmodelpack/entities/enderchest.mdl")
ENT.Spawnable = util.IsValidModel("models/mcmodelpack/entities/enderchest.mdl")
...
ENT.OpenSounds = {Sound("enderchest/open.wav")}
ENT.CloseSounds = {Sound("enderchest/close.wav")}
