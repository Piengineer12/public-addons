...
ENT.Type = "anim"
ENT.PrintName = "Large Chest"
ENT.Category = "Containers - MC"

AddCSLuaFile()

ENT.ContainerModel = Model("models/mcmodelpack/entities/bigchest-new.mdl")
ENT.Spawnable = util.IsValidModel("models/mcmodelpack/entities/bigchest-new.mdl")
