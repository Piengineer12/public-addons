...
concommand.Add("hud_sway_reset", function()
	ConA:Revert()
	ConB:Revert()
	ConC:Revert()
	ConD:Revert()
	...
	ConX:Revert()
	ConY:Revert()
end, nil, "Resets all hud_sway ConVars to their defaults.")
...
hook.Add("AddToolMenuCategories","HudSoiSoiSoi",function()
	spawnmenu.AddToolCategory("Options","HUDSway","HUDSway + Scale")
end)
...
hook.Add("PopulateToolMenu","HudSwoiSwoiSwoi",function()
	spawnmenu.AddToolMenuOption("Options","HUDSway","HUDSway_Options","Options","","",function(DForm) -- Add panel
		...
		local dangerbutton = DForm:Button("Set All ConVars To Default","hud_sway_reset")
